...
from monthly_branch_performance.lib import create_monthly_branch_performance, insert_into_branch_performance
...
def main():
    try:
        ...
        monthly_branch_performance = create_monthly_branch_performance()
        create_table_if_not_exists(table_env, "monthly_branch_performance", monthly_branch_performance)
