...
from daily_finance_performance.lib import create_daily_finance_performance, insert_into_daily_finance_performance
...
def main():
    try:
        ...
        daily_finance_performance = create_daily_finance_performance()
        create_table_if_not_exists(table_env, "daily_finance_performance", daily_finance_performance)

        insert_into_daily_finance_performance(table_env)
