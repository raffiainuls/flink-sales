...
from branch_monthly_finance_performance.lib import create_branch_monthly_finance_performance, insert_into_branch_monthly_finance_performance
...
def main():
    try:
        ...
        branch_monthly_finance_performance = create_branch_monthly_finance_performance()
        create_table_if_not_exists(table_env, "branch_monthly_finance_performance", branch_monthly_finance_performance)

        insert_into_branch_monthly_finance_performance(table_env)
