...
from finance_performance.lib import create_finance_performance, insert_into_finance_performance
...
def main():
    try:
        ...
        finance_performance = create_finance_performance()
        create_table_if_not_exists(table_env, "finance_performance", finance_performance)

        insert_into_finance_performance(table_env)
