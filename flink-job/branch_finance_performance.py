...
from branch_finance_performance.lib import create_branch_finance_performance, insert_into_branch_finance_performance
...
def main():
    try:
        ...
        branch_finance_performance = create_branch_finance_performance()
        create_table_if_not_exists(table_env, "branch_finance_performance", branch_finance_performance)

        insert_into_branch_finance_performance(table_env)
